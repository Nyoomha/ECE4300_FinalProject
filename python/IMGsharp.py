...
source_directory = "/home/saladbot/eceproject/ECE4300_FinalProject/Images/"
destination_directory = "/home/saladbot/eceproject/ECE4300_FinalProject/Images/sharpIMGDone"
...
for filename in os.listdir(source_directory):
    if filename.lower().endswith(('.jpg', '.jpeg', '.png', '.bmp', '.gif')):
        ...
        if input_image is not None:
            ...
            print(f"Image sharpened and saved: {destination_path}")
